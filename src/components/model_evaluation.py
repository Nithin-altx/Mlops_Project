from src.entity.config__entity import ModelEvaluationConfig
from src.entity.artifact__entity import DataIngestionArtifact,ModelTrainerArtifact,ModelEvaluationArtifact
